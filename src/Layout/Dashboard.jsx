            ...
            <section className="w-70 bg-[#D99904] min-h-screen">
                <div className="pl-6 pt-12">
                    ...
                    <ul className="uppercase mt-14 space-y-6 font-medium">
                        <li> <NavLink className="flex items-center gap-3" > <RiHome9Fill size={24} />  User Home</NavLink> </li>
                        <li> <NavLink className="flex items-center gap-3"><FaCalendarAlt size={24} /> Reservation</NavLink> </li>
